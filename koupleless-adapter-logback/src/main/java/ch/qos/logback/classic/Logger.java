...
public final class Logger implements org.slf4j.Logger, LocationAwareLogger,
    ...
    public synchronized void setLevel(Level newLevel) {
        ...
        // inform listeners
        getLoggerContext().fireOnLevelChange(this, newLevel);
    }
    ...
    public void callAppenders(ILoggingEvent event) {
        ...
        if (writes == 0) {
            getLoggerContext().noAppenderDefinedWarning(this);
        }
    }
    ...
    Logger createChildByLastNamePart(final String lastPart) {
        ...
        if (i_index != -1) {
            throw new IllegalArgumentException(
                "Child name [" + lastPart + " passed as parameter, may not include ["
                                               + CoreConstants.DOT + "]");
        }
        ...
        if (this.isRootLogger()) {
            childLogger = new Logger(lastPart, this, getLoggerContext());
        } else {
            childLogger = new Logger(name + CoreConstants.DOT + lastPart, this, getLoggerContext());
        }
    ...
    Logger createChildByName(final String childName) {
        ...
        if (i_index != -1) {
            throw new IllegalArgumentException(
                "For logger [" + this.name + "] child name [" + childName
        ...
        Logger childLogger;
        childLogger = new Logger(childName, this, getLoggerContext());
        childrenList.add(childLogger);
        childLogger.effectiveLevelInt = this.effectiveLevelInt;
        return childLogger;
    }
    ...
    private void filterAndLog_0_Or3Plus(final String localFQCN, final Marker marker,
        ...
        final FilterReply decision = getLoggerContext()
    ...
    private void filterAndLog_1(final String localFQCN, final Marker marker, final Level level,
        ...
        final FilterReply decision = getLoggerContext().getTurboFilterChainDecision_1(marker, this,
            level, msg, param, t);
    ...
    private void filterAndLog_2(final String localFQCN, final Marker marker, final Level level,
        ...
        final FilterReply decision = getLoggerContext().getTurboFilterChainDecision_2(marker, this,
    ...
    private FilterReply callTurboFilters(Marker marker, Level level) {
        return getLoggerContext().getTurboFilterChainDecision_0_3OrMore(marker, this, level, null,
            null, null);
    }
    ...
    public void log(org.slf4j.event.LoggingEvent slf4jEvent) {
        ...
        filterAndLog_0_Or3Plus(FQCN, slf4jEvent.getMarker(), level, slf4jEvent.getMessage(),
            slf4jEvent.getArgumentArray(), slf4jEvent.getThrowable());
    }
