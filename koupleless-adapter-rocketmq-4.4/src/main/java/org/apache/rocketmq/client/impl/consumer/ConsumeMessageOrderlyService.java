...
public class ConsumeMessageOrderlyService implements ConsumeMessageService {
    ...
    public ConsumeMessageDirectlyResult consumeMessageDirectly(MessageExt msg, String brokerName) {
        ...
        try {
            ...
            log.warn(String.format("consumeMessageDirectly exception: %s Group: %s Msgs: %s MQ: %s",
                ...
                ConsumeMessageOrderlyService.this.consumerGroup, msgs, mq), e);
        }
    ...
    public void tryLockLaterAndReconsume(final MessageQueue mq, final ProcessQueue processQueue,
        ...
        this.scheduledExecutorService.schedule(new Runnable() {
            ...
            public void run() {
                ...
                if (lockOK) {
                    ConsumeMessageOrderlyService.this.submitConsumeRequestLater(processQueue, mq,
                        10);
                } else {
                    ConsumeMessageOrderlyService.this.submitConsumeRequestLater(processQueue, mq,
                        3000);
    ...
    private void submitConsumeRequestLater(final ProcessQueue processQueue,
        ...
        this.scheduledExecutorService.schedule(new Runnable() {
            ...
            @Override
            public void run() {
                ConsumeMessageOrderlyService.this.submitConsumeRequest(null, processQueue,
                    messageQueue, true);
            }
    ...
    public boolean sendMessageBack(final MessageExt msg) {
        try {
            ...
            log.error("sendMessageBack exception, group: " + this.consumerGroup + " msg: "
                      + msg.toString(),
                e);
        }
            ...
            synchronized (objLock) {
                if (MessageModel.BROADCASTING.equals(
                    ...
                    for (boolean continueConsume = true; continueConsume;) {
                        ...
                        if (!msgs.isEmpty()) {
                            final ConsumeOrderlyContext context = new ConsumeOrderlyContext(
                                this.messageQueue);

                            ConsumeOrderlyStatus status = null;

                            ConsumeMessageContext consumeMessageContext = null;
                            if (ConsumeMessageOrderlyService.this.defaultMQPushConsumerImpl
                                .hasHook()) {
                            ...
                            try {
                                ...
                                log.warn("consumeMessage exception: {} Group: {} Msgs: {} MQ: {}",
                                    RemotingHelper.exceptionSimpleDesc(e),
                                    ConsumeMessageOrderlyService.this.consumerGroup, msgs,
                                    messageQueue);
                                hasException = true;
                            } finally {
                            ...
                            } else if (consumeRT >= defaultMQPushConsumer.getConsumeTimeout() * 60
                                                    * 1000) {
                            ...
                            continueConsume = ConsumeMessageOrderlyService.this
